...
class AgentInput:
    ...
    #     if use_fut_frames:
    #         len_frame = self.scene_metadata.num_history_frames + self.scene_metadata.num_future_frames
    #     else:
    #         len_frame = self.scene_metadata.num_history_frames

    #     for frame_idx in range(len_frame):
    #         frame_ego_status = self.frames[frame_idx].ego_status

    #         if frame_idx < self.scene_metadata.num_history_frames:
    #             ego_statuses.append(
    #                 EgoStatus(
...
class Scene:
    ...
    def get_future_trajectory(self, 
        ...
        start_frame_idx = self.scene_metadata.num_history_frames - 1 + frame_offset
